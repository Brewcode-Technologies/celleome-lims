    ...
    <section className="py-16 md:py-32 bg-muted/20" id="why-us">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Experience the difference with our AI-powered LIMS solution</p>
        </div>
        <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
          ...
          <GridItem
            ...
            description="Connect with all your existing laboratory instruments and systems without disruption."
          />
          <GridItem
