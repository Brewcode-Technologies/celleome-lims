...
import { Mail, Phone, MapPin, Linkedin, Twitter, Github, Globe, Shield } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-16 pb-12">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center space-x-2">
              <img src={celleomeFooterLogo} alt="Celleome Diagnostics" className="h-15 w-auto" />
            </div>
            <p className="text-sm leading-relaxed text-muted-foreground">
              AI-powered Laboratory Information Management System (LIMS) for pharmaceutical,
